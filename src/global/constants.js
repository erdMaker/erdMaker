...
export const relationshipWidth = 67; // Measured from the center to either the left or right vertex
export const relationshipHeight = 47; // Measured from the center to either the top or bottom vertex
export const relationshipTextWidth = 90;
export const attributeRadiusX = 56;
export const attributeRadiusY = 32;
